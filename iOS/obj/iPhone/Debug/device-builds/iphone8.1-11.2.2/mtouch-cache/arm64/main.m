...
extern void *mono_aot_module_Weatherapp_iOS_info;
...
extern void *mono_aot_module_Weatherapp_info;
...
{
	mono_aot_register_module (mono_aot_module_Weatherapp_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Weatherapp_info);
